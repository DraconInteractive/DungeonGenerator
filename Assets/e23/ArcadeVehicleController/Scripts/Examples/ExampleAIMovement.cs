...
namespace e23.VehicleController.Examples
{
    ...
    {
        [SerializeField] ExampleWaypath waypath;
        [SerializeField] bool canDrive = false;
        [SerializeField] float minimalDistanceToNextWaypoint = 0.05f;
        ...
        public float frontSensorStartPoint = 1.0f;
        public float SensorHeight = 1.0f;
        public float rearSensorStartPoint = 5.0f;
        public float sideSensorEndOffset = 30.0f;
        ...
        private void ForwardDrivingSensor()
        {
            ...
            Physics.Raycast(posFrontMid, transform.forward, out hit, sensorLength);
