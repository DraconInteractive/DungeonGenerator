...
namespace e23.VehicleController.Demo
{
    ...
    {
        [SerializeField] List<SwapData> vehiclesToSwap;
        [SerializeField] GameObject aiCamera;
        [SerializeField] GameObject helicopterControls;
        ...
        public void SwapVehicle(int index)
        {
            ...
            helicopterControls.SetActive(vehiclesToSwap[activeVehicle].isHelicopter);
        }
